  ...
  useEffect(() => {
    ...
    const loadFavorites = async () => {
      ...
      try {
        ...
        console.error("Failed to load favorites weather", err);
        dispatch({ type: 'FETCH_ERROR', payload: 'Błąd pobierania danych' });
      }
    };
    ...
    return (
      <div className="container mx-auto px-4">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full animate-[fadeIn_0.5s_ease-out] mt-8">
          <CityCapsuleSkeletons count={favorites.length || 3} />
        </section>
      </div>
    );
  }
